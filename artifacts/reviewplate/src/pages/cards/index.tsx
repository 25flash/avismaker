...
import { CreditCard, Plus, ExternalLink, Activity, Power, PowerOff } from "lucide-react";
    ...
    <AuthLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-[#0D1117]">Cards</h1>
            <p className="text-sm text-[#6B7280] mt-0.5">Manage your NFC and QR review cards</p>
          </div>
          <Link href="/activate">
        ...
        {isLoading ? (
          ...
          <Card className="bg-white border border-border">
            <CardContent className="py-16 text-center">
              ...
              <h3 className="text-lg font-semibold text-[#0D1117] mb-2">No cards yet</h3>
              <p className="text-sm text-[#6B7280] mb-6 max-w-xs mx-auto">
                Activate your first NFC or QR review card to start collecting reviews automatically.
              </p>
              <Link href="/activate">
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      {card.platform ? (
                        ...
                        <span className="text-xs text-[#9CA3AF]">No platform set</span>
                      )}
